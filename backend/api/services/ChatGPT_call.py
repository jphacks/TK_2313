...
light1_brightness=GPTFunctionProperties("light1_brightness", "integer", "ライトの明るさ")

set_light1_color=GPTFunction("set_light1_color", "ライトの色を変更します", GPTFunctionParam([light1_red,light1_green,light1_blue], [light1_red,light1_green,light1_blue]),lambda _red,_green,_blue:set_color((_red,_green,_blue)))
set_light1_brightness=GPTFunction("set_light1_brightness", "ライトの明るさを変更します", GPTFunctionParam([light1_brightness], [light1_brightness]),lambda _brightness:set_brightness(_brightness))
turn_on_light1=GPTFunction("turn_on_light1", "ライトをオンにします", GPTFunctionParam([], []),lambda :turn_on())
turn_off_light1=GPTFunction("turn_off_light1", "ライトをオフにします", GPTFunctionParam([], []),lambda :turn_off())

# チャットログのインスタンスの作成
chat = Chat(API_TOKEN, model=Model.gpt4, function=[set_light1_color,set_light1_brightness,turn_on_light1,turn_off_light1])
